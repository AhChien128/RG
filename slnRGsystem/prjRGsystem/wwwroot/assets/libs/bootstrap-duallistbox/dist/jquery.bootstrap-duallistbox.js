...
;(function ($, window, document, undefined) {
  ...
  var pluginName = 'bootstrapDualListbox',
    defaults = {
      ...
      filterTextClear: '查看全部',
      filterPlaceHolder: '關鍵字',
      moveSelectedLabel: '選擇已選項目',
      moveAllLabel: '選擇全部',
      removeSelectedLabel: '刪除已選項目',
      removeAllLabel: '刪除全部',
      ...
      infoText: '已選擇 {0}',                                                        // text when all options are visible / false for no info text
      infoTextFiltered: '<span class="label label-warning">Filtered</span> {0} from {1}', // when not all of the options are visible due to the filter
      infoTextEmpty: '請選擇',                                                        // when there are no options present in the list
