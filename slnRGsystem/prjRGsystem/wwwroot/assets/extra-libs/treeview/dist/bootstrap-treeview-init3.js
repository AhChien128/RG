$(function() {
        ...
        var defaultData = [
          {
            text: '<span class="fs-4 fw-bold me-2">  駐諾魯技術團-承辦人-XXX</span> <span class="badge ms-auto bg-success " style="float:right;">如擬</span> <div style="margin-left:25px">送出時間 2022/02/10 10:00</div>',
            href: '#parent1',
            tags: ['0'],
            
          },
          {
            text: '<span class="fs-4 fw-bold me-2">  駐諾魯技術團-團長-XXX</span> <span class="badge ms-auto bg-success " style="float:right;">如擬</span> <div style="margin-left:25px">送出時間 2022/02/10 11:00</div>',
            href: '#parent2',
            tags: ['0']
          },
          {
              text: '<span class="fs-4 fw-bold return me-2">  技術合作處-承辦人-XXX</span> <span class="badge ms-auto bg-warning " style="float:right;">退回</span> <div style="margin-left:25px">送出時間 2022/02/11 16:00</div> ',
            href: '#parent3',
             tags: ['0']
          }
        ];
        ...
        $('#treeview4').treeview({
          selectedBackColor: "#26c6da",
          onhoverColor: "rgba(0, 0, 0, 0.05)",
          expandIcon: 'ti-plus',
          collapseIcon: 'ti-minus',
          nodeIcon: ' fas fa-user-circle',
          data: defaultData
        });
